...
// This is the original single-page dashboard, unchanged in behaviour — moved
// here verbatim from App.tsx so it can sit behind the 今天 tab instead of
// being the whole page. ops.status and project.tree are the two operations
// guaranteed present in every build, so this view never needs a capability
// gate the way the other six do.
export function TodayView({ ds }: { ds: DataSource }) {
